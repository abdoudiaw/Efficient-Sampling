...
npts = 500 #16 #125 #2 #500 # number of solvers used in a searcher
direct = False # optimizer-directed sampling or not
...
avetol = 1e-7 # ave tol for valid
reptol = 2e-6 # stop when rep converges so rep iters <= reptol
nrep = 3 # this is hist.values()[-rep:] <= reptol
nlast = 3 # this is any(size[-nlast:])
maxloops = 30 # max number of loops

# objective
from mystic.models import easom as objective
