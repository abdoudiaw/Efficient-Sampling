...
bounds = [(0.012,0.588),(0.04,1.542)]  #* shape[0] # bounds (lower is 0.012) on input parameters

# define hypercube for plotting
#hcube = '{0}:{1}:{2}, {0}:{1}:{2}'.format(lower, upper, upper/50.)
hcube='0.012:0.588:0.012, 0.04:1.542:0.015'
hcube += ''
...
# objective
from objective import presssure as model
