...
npts = 40 #125 #2 #500 # number of solvers used in a searcher
...
sumtol = 1.e-2 #1e-3 # ave tol for valid
...
maxloops = 1 # max number of loops

# objective
#from mystic.models import ackley as objective
from skyrme_bag_hybrid import pressure as objective
